class SlotGame {
  constructor(reelsCount, rowsCount, reels, lines, symbols) {
  ...
  spin() {
    ...
    for (const line of this.lines) {
      const symbol = result[line[0]][0];
      const count = line.filter((pos) => result[pos][0] === symbol).length;
      console.log(`Line payout: ${this.symbols[symbol][count - 1]}`);
    }
  }
}
